...
export default function IncidentCard({ incident }) {
  ...
  return (
    <div className="card incident-card" onClick={() => navigate(`/incidents/${incident._id}`)}>
      ...
      <p className="record-content"><strong>Assigned:</strong> {incident.assignedTo?.name || "Unassigned"}</p>
